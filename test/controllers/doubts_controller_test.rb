...
class DoubtsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create doubt" do
    assert_difference('Doubt.count') do
      post doubts_url, params: { doubt: { code: @doubt.code, comment: @doubt.comment, contact: @doubt.contact, question: @doubt.question } }
    end
  ...
  test "should update doubt" do
    patch doubt_url(@doubt), params: { doubt: { code: @doubt.code, comment: @doubt.comment, contact: @doubt.contact, question: @doubt.question } }
